const contentLetterSrart_actived = "Happy birthday em bé của anhhhh🎉🎊🎂🎁🎉"; //Lời mở đầu cho bức thư
const mainContentLetter =
  "Chúc em bé của anh tuổi mới lun vui vẻ và đạt được những điều mà mình mong muốn. Năm nay, anh khum đón sinh nhật cùng với bé được. Chắc cũng phải 1,2 năm nữa thì anh mới được đón sinh nhật trọn vẹn cùng với bé. Bé đừng giận anh nữa nhớ👉👈, anh xin lỗi bé👉👈. Cuối cùng thì anh cũng chúc cho cả 2 có thể đi với nhau lâu nhất có thế❤. Iu em bé của anh❤"; //Nội dung của bức thư
